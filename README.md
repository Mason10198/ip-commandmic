...
Status: **1.0.0rc3 release candidate under final verification**. The latest
published prerelease remains [1.0.0rc2](https://github.com/Mason10198/ip-commandmic/releases/tag/v1.0.0rc2).
